...
import { ref } from 'vue'
import { statusOptions } from '../src/hooks/commitment'
import type { CommitmentForm, CommitmentStatus } from '../src/types/commitment'

const model = defineModel<CommitmentForm>({
  default: {
    reportName: '',
    timeRange: null,
    initiator: '',
    ...
    status: '进行中' as CommitmentStatus
  }
})
