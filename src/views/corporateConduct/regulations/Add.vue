<template>
  <n-modal v-model:show="addModal.status" preset="card" title="新增制度文件" style="width: 620px" :mask-closable="false">
    <RegulationForm ref="formRef" v-model="regulationSave.form" />
    <template #footer>
      <div class="editor-footer">
        <n-button @click="regulationSave.closeAdd()">取消</n-button>
...
import { addModal } from './src/service/regulation'
