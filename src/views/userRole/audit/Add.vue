<template>
  <n-modal v-model:show="addModal.status" preset="card" title="新增用户" style="width: 560px" :mask-closable="false">
    <UserForm ref="formRef" v-model="userSave.form" />
    <template #footer>
      <div class="editor-footer">
        <n-button @click="userSave.closeAdd()">取消</n-button>
...
import { addModal } from './src/service/user'
